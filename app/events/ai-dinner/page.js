...
const schedule = [
  {
    time: "18:00 – 18:30",
    activity: "Arrival, Registration & Welcome Refreshments",
  },
  {
    time: "18:30 – 18:45",
    activity: "Opening Remarks & Introduction to ARIFA AI Dinner",
  },
  {
    time: "18:45 – 19:15",
    activity: "Keynote Presentation: The Future of AI in Africa",
  },
  {
    time: "19:15 – 19:35",
    activity: "AI Innovation Showcase & Industry Insights",
  },
  { time: "19:35 – 20:00", activity: "Entertainment Session" },
  { time: "20:00 – 20:45", activity: "Executive Dinner" },
  {
    time: "20:45 – 21:15",
    activity: "High-Level Networking & Partnership Engagement",
  },
  {
    time: "21:15 – 22:00",
    activity: "Music, Social Interaction & Closing Moments",
  },
];
const expectations = [
      ...
      <section className="page-hero">
        ...
        <div className="max-w-[1200px] w-full mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-[800px] mx-auto animate-fadeInUp animate-delay-100 font-medium">
            {" "}
            Theme: Shaping Africa’s AI Future Through Collaboration, Innovation,
            and Leadership{" "}
          </p>{" "}
        </div>{" "}
      </section>{" "}
              ...
              <RevealOnScroll>
                ...
                <div className="max-w-none">
                  ...
                  <p className="text-lg text-black leading-relaxed text-justify">
                    ...
                    annual gathering that will bring together leaders,
                    innovators, policymakers, researchers, industry executives,
                    development partners, entrepreneurs, and AI enthusiasts to
                  ...
                  <p className="text-lg text-black leading-relaxed mt-4 text-justify">
                    ...
                    missions, academia, private sector organizations,
                  ...
                  <p className="text-lg text-black leading-relaxed mt-4 text-justify">
                    ...
                    innovation, and foster collaborations that can accelerate
                ...
                <div className="bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-line overflow-hidden">
                  ...
                  <div className="divide-y divide-black/10">
                    ...
                    {schedule.map((item, idx) => (
                      <div
                        key={idx}
                        className="grid md:grid-cols-[1fr_2fr] gap-2 md:gap-4 p-6 hover:bg-white transition-colors"
                      >
                        {" "}
            ...
            <div className="lg:col-span-1">
              ...
              <RevealOnScroll delay={400}>
                ...
                <div className="bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-line p-8 sticky top-32">
                  ...
                  <Link
                    href="/contact-us"
                    className="block w-full py-4 bg-primary text-white text-center rounded-xl font-bold hover:bg-primary hover:shadow-lg transition-all hover:-translate-y-0.5"
                  >
                    {" "}
                    Reserve Your Seat{" "}
                  </Link>{" "}
