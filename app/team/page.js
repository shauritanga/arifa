  ...
  return (
    <RevealOnScroll delay={(index % 4) * 100} className="h-full">
      ...
      <button
        ...
        className="group relative flex h-full w-full flex-col overflow-hidden rounded-2xl border border-black/10 bg-white text-left shadow-[0_18px_45px_rgba(0,0,0,0.06)] transition-all duration-300 hover:-translate-y-2 hover:border-[#00803D]/60 hover:shadow-[0_24px_60px_rgba(0,0,0,0.12)] focus:outline-none focus-visible:ring-4 focus-visible:ring-[#00803D]/30"
      >
        {" "}
        <div className="relative mx-6 mt-6 aspect-[4/5] overflow-hidden rounded-xl bg-white">
          {" "}
          <div className="absolute right-0 top-0 z-10 h-16 w-16 border-r border-t border-[#00803D]" />{" "}
          <Image
            src={imageSrc}
            alt={member.name}
            fill
          ...
          />{" "}
          <span className="absolute bottom-4 left-4 rounded-full bg-white/90 px-3 py-1 text-xs font-bold uppercase tracking-[0.08em] text-[#990000] shadow-sm ">
            {" "}
            {category}{" "}
          </span>{" "}
        </div>{" "}
        <div className="flex flex-1 flex-col p-6">
          ...
          <div className="mb-4">
            ...
            <h3 className="font-[var(--font-heading)] text-xl font-extrabold leading-tight text-black">
              {" "}
              {member.name}{" "}
            </h3>{" "}
          </div>{" "}
          <p className="mb-6 line-clamp-3 text-sm leading-relaxed text-black/70">
            {" "}
            {member.bio}{" "}
          </p>{" "}
      ...
      <section className="relative pt-40 pb-24 bg-primary overflow-hidden">
        ...
        <div className="max-w-[1200px] w-full mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-[700px] mx-auto animate-fadeInUp animate-delay-200">
            ...
            driving innovation in AI and digital transformation across
            Africa.{" "}
          </p>{" "}
        </div>{" "}
      </section>{" "}
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-16 animate-fadeInUp">
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-6 sm:px-8 py-3 rounded-full text-sm font-semibold transition-all duration-300 ${activeTab === category ? "bg-[#990000] text-white shadow-lg shadow-[#990000]/30 -translate-y-1" : "bg-white text-black hover:bg-white border border-black/10 shadow-sm hover:-translate-y-1"}`}
              >
                {" "}
                {category}{" "}
              </button>
            ...
            <RevealOnScroll key={activeTab}>
              ...
              <div className="mx-auto mb-12 max-w-[760px] text-center">
                ...
                <p className="mt-4 text-black/70">
                  {" "}
                  Explore the people shaping ARIFA&apos;s research, governance,
                  partnerships, and day-to-day institutional work.{" "}
                </p>{" "}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="bg-white rounded-2xl overflow-hidden w-full max-w-4xl max-h-[90vh] flex flex-col md:flex-row relative z-10 shadow-2xl animate-fadeInUp">
            ...
            <button
              ...
              className="absolute top-4 right-4 w-10 h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center text-black z-20 transition-colors shadow-sm focus:outline-none focus-visible:ring-4 focus-visible:ring-[#00803D]/30"
            >
              {" "}
              <i className="fas fa-times text-xl" aria-hidden="true" />{" "}
            </button>{" "}
            <div className="w-full md:w-2/5 h-72 md:h-auto relative bg-white">
              {" "}
              <Image
            ...
            <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto">
              ...
              <h2 className="text-3xl font-extrabold text-black font-[var(--font-heading)] mb-6">
                {" "}
                {selectedMember.name}{" "}
              </h2>{" "}
