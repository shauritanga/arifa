 ...
 */
export function buildSelcomHeaders(payload, timestamp = new Date().toISOString()) {
 ...
 * as "valid".
 */
export function verifyWebhookSignature(payload, providedDigest, signedFields, timestamp) {
