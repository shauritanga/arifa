/**
 * Prices are quoted to visitors in USD, but Selcom settles in Tanzanian
 * shillings (see lib/selcom/config.js — the gateway is hardcoded to TZS).
 *
...
/** "TSh 1,950,000" — what Selcom actually bills. */
