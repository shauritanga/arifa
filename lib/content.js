...
export const COLLECTIONS = {
  RESEARCH_PROJECT: {
    ...
    imageHint: "Main photo for the project listing and detail page.",
    // Matches original arifa.org project categories (sidebar filter + meta badge).
    group: {
      label: "Category",
      required: true,
      allowCustom: true,
    ...
    fields: [
      {
        ...
        label: "Project dates",
        kind: "text",
        hint: "Shown under the cover image (e.g. 01 Jan 25 – 01 Aug 25).",
      },
      {
        key: "content",
        ...
        kind: "html",
        required: true,
        hint: "Full project story. Use the visual editor for headings, lists, images, and formatting.",
      },
    ],
  },
  ...
  TEAM_MEMBER: {
    ...
    fields: [
      ...
      },
      {
        ...
        kind: "html",
        required: true,
        hint: "Shown when visitors click View Bio. Use the visual editor for headings, lists, and formatting.",
      },
    ],
  },
  ...
  CERTIFICATION: {
    ...
    hasImage: true,
    imageLabel: "Cover image",
    imageHint: "Photo shown on the certification card and detail page.",
    ...
    fields: [
      {
        ...
        kind: "textarea",
        required: true,
        hint: "Brief summary on the certifications listing card.",
      },
      {
        key: "sections",
        label: "Detail sections",
        kind: "sections",
        hint: "Same order as the public page. Certificate Modules is always last.",
      },
  ...
  MASTERCLASS: {
    ...
    fields: [
      ...
      // Selcom bills Tanzanian shillings, so a seat cannot be sold until it has
  ...
  PUBLICATION: {
    ...
    titleLabel: "Title",
    // Addressable at /publications/<slug> on this site.
    hasSlug: true,
    hasImage: true,
    imageLabel: "Cover image",
    imageHint: "Cover shown on the card and detail page.",
    // Matches original arifa.org publication categories.
    group: {
      label: "Category",
      required: true,
      allowCustom: true,
    ...
    fields: [
      {
        ...
        label: "Year",
        kind: "text",
        hint: "Optional year label (e.g. 2025).",
      },
      {
        key: "authors",
        label: "Authors",
        kind: "text",
        hint: "Optional — shown on the card and detail page.",
      },
      {
        key: "venue",
        label: "Venue / publisher",
        kind: "text",
        hint: "Optional journal, conference, or series name.",
      },
      {
        key: "summary",
        label: "Summary / abstract",
        kind: "html",
        hint: "Shown on the on-site detail page. Use the visual editor for formatting.",
      },
      {
        key: "link",
        label: "External PDF / resource link",
        kind: "url",
        hint: "Optional download or external resource. Cards open the on-site detail page first.",
      },
    ],
  },
  ...
  COURSE: {
    ...
    fields: [
      ...
      // charged: Selcom bills whole Tanzanian shillings, so a course cannot be
  ...
  JOB: {
    ...
    imageHint: "Shown on the left of the career card. Upload from your device.",
    fields: [
      ...
      },
      {
        ...
        kind: "html",
        required: true,
        hint: "Shown when visitors click View more. Use headings and bullet lists for responsibilities, requirements, and how to apply.",
        placeholder:
          "Write the full role details…\n\nTip: add headings like “What you’ll do”, “What we’re looking for”, and “How to apply”, then use bullet lists under each.",
      },
    ],
  },
  ...
  SPONSOR: {
    ...
    imageLabel: "Logo",
    imageHint:
      "Upload the organization logo (PNG or SVG preferred). Shown in the partners marquee on the homepage.",
    fields: [
      {
        key: "url",
        label: "Website (optional)",
        kind: "url",
        hint: "If set, the logo links to this page.",
      },
    ],
  },
};
...
export function flatten(item) {
  ...
  if (typeof flat.bio === "string") {
    flat.bio = balanceHtml(flat.bio);
  }
  if (typeof flat.details === "string") {
    flat.details = balanceHtml(flat.details);
  }
...
export async function getBySlug(collection, slug) {
  const item = await prisma.contentItem.findFirst({
    where: {
      collection,
      published: true,
      slug: { equals: String(slug ?? ""), mode: "insensitive" },
    },
  });
